import{l as d,o as m,b as i,g as h,e as D,n as u,s as W,p as V,x as P}from"./vue.esm-bundler-2dba5e38.js";import{_ as x}from"./Logo-e2532857.js";import E from"./BrandBarDocs-b839d88b.js";import"./jsx-runtime-e45ac621.js";import"./index-e40bb458.js";import"./iframe-57a90473.js";import"../sb-preview/runtime.js";import"./index-f4dda215.js";import"./index-1b441bc2.js";import"./index-356e4a49.js";import"./package-68a66de7.js";import"./index-8a7f7229.js";const N={name:"researchbase-research-bar",components:{ResearchLogo:x},props:{narrow:{type:Boolean,default:!1}},setup(e,r){const t=d(()=>{let o=["research-bar"];return(e.narrow||r.slots.second_row_content)&&o.push("research-bar--narrow"),o}),n=d(()=>r.slots.parent_title&&r.slots.parent_title().length||r.slots.bottom_content&&r.slots.bottom_content().length);return{getClasses:t,showBottomBar:n}}},I=(e,r)=>{const t=e.__vccOpts||e;for(const[n,o]of r)t[n]=o;return t},O={class:"research-bar__container"},z={key:0,class:"research-bar__below"},F={class:"research-bar__container"};function L(e,r,t,n,o,j){const R=P("research-logo");return m(),i("header",{class:V(n.getClasses),"data-research-header":""},[h("div",O,[D(R),u(e.$slots,"default")]),e.$slots.second_row_content?(m(),i("div",z,[h("div",F,[u(e.$slots,"second_row_content")])])):W("",!0)],2)}const p=I(N,[["render",L]]);N.__docgenInfo={displayName:"researchbase-research-bar",description:`The Washu Brand Bar is the visual starting point for all
branded websites and applications.`,tags:{},exportName:"default",props:[{name:"narrow",description:"Determines whether to use the narrow version of the bar.",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],slots:[{name:"default",description:"Default slot shows content next to the logo."},{name:"second_row_content"}],sourceFiles:["/home/runner/work/dnkemper/dnkemper/src/components/brand-bar/BrandBar.vue"]};const ae={title:"Components/Branding/Brand Bar",component:p,tags:["autodocs"],argTypes:{narrow:{control:{type:"boolean"}},default:{control:{type:"text"}},second_row_content:{control:{type:"text"}}},parameters:{docs:{source:{code:null},page:E}}},M=e=>({components:{ResearchBar:p},setup(){return{args:e}},template:`
...
\`
})`,...(T=(S=c.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var y,k,C;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`args => ({
  components: {
    ResearchBar
  },
  setup() {
